...
import { PostNotFound } from "../components/post-not-found/post-not-found";
@Component({
  selector: 'app-post-view',
  imports: [NavBar, PostComponent, ReportPopup, ErrorShow, DeletePostPopup, SuccuesShow, PostNotFound],
